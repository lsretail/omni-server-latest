...
namespace LSOmni.DataAccess.BOConnection.CentrAL.Dal
{
    public class StaffRepository : BaseRepository
    {
        ...
        public StaffRepository(BOConfiguration config) : base(config)
        {
            ...
            sqlfrom = " FROM [" + navCompanyName + "Staff$5ecfc871-5d82-43f1-9c54-59685e82318d] mt";
        }
        ...
        public List<ReplStaff> ReplicateStaff(string storeId, int batchSize, bool fullReplication, ref string lastKey, ref string maxKey, ref int recordsRemaining)
        {
            ...
            List<JscKey> keys = GetPrimaryKeys("Staff$5ecfc871-5d82-43f1-9c54-59685e82318d");
            ...
            sql = GetSQL(fullReplication, 0) + sqlcolumns + sqlfrom +
                        ...
                        " FROM [" + navCompanyName + "Staff Store Link$5ecfc871-5d82-43f1-9c54-59685e82318d] sl" +
                        " LEFT OUTER JOIN [" + navCompanyName + "Staff$5ecfc871-5d82-43f1-9c54-59685e82318d] mt ON sl.[Staff ID]=mt.[ID]" +
