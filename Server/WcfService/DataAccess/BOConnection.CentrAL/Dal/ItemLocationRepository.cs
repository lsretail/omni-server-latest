...
namespace LSOmni.DataAccess.BOConnection.CentrAL.Dal
{
    public class ItemLocationRepository : BaseRepository
    {
        ...
        public ItemLocationRepository(BOConfiguration config) : base(config)
        {
            ...
            sqlfrom = " FROM [" + navCompanyName + "Item Section Location$5ecfc871-5d82-43f1-9c54-59685e82318d] mt" +
                      " LEFT JOIN [" + navCompanyName + "Section Shelf$5ecfc871-5d82-43f1-9c54-59685e82318d] se" +
                      " ON se.[Section Code]=mt.[Section Code] AND se.[Code]=mt.[Shelf Code] AND se.[Store No_]=mt.[Store No_]" +
                      " LEFT JOIN [" + navCompanyName + "Store Section$5ecfc871-5d82-43f1-9c54-59685e82318d] st" +
        ...
        public List<ReplItemLocation> ReplicateItemLocation(string storeId, int batchSize, bool fullReplication, ref string lastKey, ref string maxKey, ref int recordsRemaining)
        {
            ...
            List<JscKey> keys = GetPrimaryKeys("Item Section Location$5ecfc871-5d82-43f1-9c54-59685e82318d");
