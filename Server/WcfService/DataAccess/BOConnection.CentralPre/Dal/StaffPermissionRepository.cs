...
namespace LSOmni.DataAccess.BOConnection.CentralPre.Dal
{
    public class StaffPermissionRepository : BaseRepository
    {
        ...
        public StaffPermissionRepository(BOConfiguration config) : base(config)
        {
            ...
            sqlfrom = " FROM [" + navCompanyName + "LSC Staff$5ecfc871-5d82-43f1-9c54-59685e82318d] st" +
                      " LEFT OUTER JOIN [" + navCompanyName + "LSC STAFF PER Group$5ecfc871-5d82-43f1-9c54-59685e82318d] spg ON spg.[Code]=st.[Permission Group]";
        }
