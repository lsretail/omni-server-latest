...
namespace LSOmni.DataAccess.BOConnection.CentralPre.Dal
{
    public class DataTranslationRepository : BaseRepository
    {
        ...
        public DataTranslationRepository(BOConfiguration config) : base(config)
        {
            ...
            sqlHtmlcolumns = "mt.[Item No_],mt.[Language],mt.[Html]";
        ...
        public List<ReplDataTranslation> ReplicateEcommDataTranslation(int batchSize, bool fullReplication, ref string lastKey, ref string maxKey, ref int recordsRemaining)
        {
            ...
            List<JscKey> keys = GetPrimaryKeys("LSC DataTranslate$5ecfc871-5d82-43f1-9c54-59685e82318d");
        ...
        public List<ReplDataTranslation> ReplicateEcommHtmlTranslation(string storeId, int batchSize, bool fullReplication, ref string lastKey, ref string maxKey, ref int recordsRemaining)
        {
            if (string.IsNullOrWhiteSpace(lastKey))
                lastKey = "0";
