...
namespace LSOmni.DataAccess.BOConnection.CentralPre
{
    public class NavActivity : NavBase, IActivityBO
    {
        ...
        {
            return LSCentralWSBase.ActivityAvailabilityGet(locationNo, productNo, activityDate, contactNo, contactAccount, optionalResource, promoCode, activityNo, noOfPersons);
        }
