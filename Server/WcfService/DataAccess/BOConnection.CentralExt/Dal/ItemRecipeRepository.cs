    ...
    public class ItemRecipeRepository : BaseRepository
    {
        ...
        public ItemRecipeRepository(BOConfiguration config) : base(config)
        {
            sqlcolumns = "mt.[Parent Item No_],mt.[Description],mt.[Line No_],mt.[Unit of Measure Code],mt.[Quantity per]," +
                         ...
                         "WHERE il.[KeyValue]=mt2.[LSC Item No_$5ecfc871-5d82-43f1-9c54-59685e82318d] AND il.[TableName]='Item' " +
                         "ORDER BY il.[Display Order]) AS ImageId";
            sqlfrom = " FROM [" + navCompanyName + "BOM Component$437dbf0e-84ff-417a-965d-ed2bb9650972$ext] mt2" +
        ...
        private ReplItemRecipe ReaderToRecipe(SqlDataReader reader, out string timestamp)
        {
            ...
            return new ReplItemRecipe()
            {
                ...
                ItemNo = SQLHelper.GetString(reader["LSC Item No_$5ecfc871-5d82-43f1-9c54-59685e82318d"]),
                UnitOfMeasure = SQLHelper.GetString(reader["Unit of Measure Code"]),
                Exclusion = SQLHelper.GetBool(reader["LSC Exclusion$5ecfc871-5d82-43f1-9c54-59685e82318d"]),
                ExclusionPrice = SQLHelper.GetDecimal(reader, "LSC Price on Exclusion$5ecfc871-5d82-43f1-9c54-59685e82318d"),
        ...
        private ItemRecipe ReaderToRecipe(SqlDataReader reader)
        {
            ...
            {
                Id = SQLHelper.GetString(reader["LSC Item No_$5ecfc871-5d82-43f1-9c54-59685e82318d"]),
                Description = SQLHelper.GetString(reader["Description"]),
                LineNo = SQLHelper.GetInt32(reader["Line No_"]),
                UnitOfMeasure = SQLHelper.GetString(reader["Unit of Measure Code"]),
                Exclusion = SQLHelper.GetBool(reader["LSC Exclusion$5ecfc871-5d82-43f1-9c54-59685e82318d"]),
