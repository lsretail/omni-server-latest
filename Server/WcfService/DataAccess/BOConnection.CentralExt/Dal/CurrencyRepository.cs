    ...
    public class CurrencyRepository : BaseRepository
    {
        ...
        public CurrencyRepository(BOConfiguration config, Version version) : base(config, version)
        {
            ...
            sqlfrom = " FROM [" + navCompanyName + "Currency$437dbf0e-84ff-417a-965d-ed2bb9650972] mt" +
                      " JOIN [" + navCompanyName + "Currency$437dbf0e-84ff-417a-965d-ed2bb9650972$ext] mt2 ON mt2.[Code]=mt.[Code]";
        }
        ...
        private ReplCurrency ReaderToCurrency(SqlDataReader reader, out string timestamp)
        {
            ReplCurrency currency = new ReplCurrency()
            {
                ...
                Symbol = SQLHelper.GetString(reader["LSC POS Currency Symbol$5ecfc871-5d82-43f1-9c54-59685e82318d"])
            };

            int cursymplacement = SQLHelper.GetInt32(reader["LSC Placement Of Curr_ Symbol$5ecfc871-5d82-43f1-9c54-59685e82318d"]);
