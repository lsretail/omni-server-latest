...
namespace Domain.Search
{
    public class ContactUs
    {
        ...
        public ContactUs(string htmlText)
        {
            ...
            {
                var headerLine = htmlText.Substring(0, htmlText.IndexOf("</p>") + 4);
            ...
            {
                var contactLine = new ContactLine();
                var line = htmlText.Substring(0, htmlText.IndexOf("</a>") + 4).TrimStart(' ');
            ...
            while (htmlText.StartsWith("<p>"))
            {
                var footerLine = htmlText.Substring(0, htmlText.IndexOf("</p>") + 4);
